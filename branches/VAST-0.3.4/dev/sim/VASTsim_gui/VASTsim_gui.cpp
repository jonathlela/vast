...
VOID Render (HWND hWnd)
{
    ...
    {        
        ...
        g_origin.x = (long)(-(nodes[0]->pos.x - 400));
        g_origin.y = (long)(-(nodes[0]->pos.y - 300));
    }
    ...
    {              
        ...
        int     x = (int)nodes[0]->pos.x;
        int     y = (int)nodes[0]->pos.y;
        aoi_t aoi = nodes[0]->aoi;
