...
namespace VAST {
    ...
    {            
        ...
        size_t n = size - (sizeof (id_t) + sizeof (msgtype_t) + sizeof (timestamp_t));
        id_t        id;
        msgtype_t   msgtype;
        timestamp_t time;
        char *p = (char *)msg;
        ...
        // extract time stamp
        memcpy (&time, p, sizeof (timestamp_t));
        ...
        if (_remote_id != NET_ID_UNASSIGNED)        
            ((net_ace *)_msghandler)->storemsg (_remote_id, msgtype, p, n, time);
    }
