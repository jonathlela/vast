...
namespace Vast {
    ...
    public:
        ...
        virtual bool is_boundary (id_t id, Position &center, length_t radius) = 0;
        ...
        virtual bool overlaps (id_t id, Position &center, length_t radius, bool accuracy_mode = false) = 0;
