...
namespace Vast
{
    ...
    query_id_t 
    StorageCS::query (char *query, size_t size)
    {
    ...
    bool 
    StorageCS::respond (query_id_t query_id, char *message, size_t size)
    {   
    ...
    bool 
    StorageCS::handlemsg (id_t from_id, msgtype_t msgtype, 
