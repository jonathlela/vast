...
EXPORT int                  InitPara (VAST_NetModel model, VASTPara_Net &netpara, SimPara &simpara, const char *cmdline = NULL, bool *is_gateway = NULL, world_t *world_id = 0, Area *aoi = NULL, Addr *gateway = NULL, vector<IPaddr> *entries = NULL);
