...
namespace VAST
{
    ...
    {
        net_emubridge::register_id (temp_id, id);
    ...
    unsigned int 
    net_emubridge_blv2::
    get_quota (bandwidth_type_t type, id_t node_id)
    {
    ...
    bool
    net_emubridge_blv2::
    spend_quota (bandwidth_type_t type, id_t node_id, size_t spent_quota)
    {
    ...
    bool 
    net_emubridge_blv2::
    set_default_quota (id_t node_id, bandwidth_type_t type, size_t quota)
    {
        std::map<id_t, size_t> * target_quota = NULL;
