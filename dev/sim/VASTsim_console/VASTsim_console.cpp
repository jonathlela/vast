...
{    
    ...
    if (ReadPara (para) == false)
    {
        ...
        else
        {
            ...
            para.WORLD_WIDTH         = atoi (argv[2]);
            para.WORLD_HEIGHT        = atoi (argv[3]);        
            para.NODE_SIZE           = atoi (argv[4]);
            para.TIME_STEPS          = atoi (argv[5]);
            para.AOI_RADIUS          = atoi (argv[6]);
            para.AOI_BUFFER          = atoi (argv[7]);
            para.CONNECT_LIMIT       = atoi (argv[8]);
            para.VELOCITY            = atoi (argv[9]);
            para.LOSS_RATE           = atoi (argv[10]);        
            para.FAIL_RATE           = atoi (argv[11]);
        }        
    }
